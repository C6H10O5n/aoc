...
namespace aoc2024
{
    internal partial class Program
    {
        ...
        static long day9LogicPart1()
        {
            ...
            var fxd = d9_data0[0].ToCharArray().Where((c, i) => i % 2 == 0).Select(c => c - '0').ToList();
            var fxs = d9_data0[0].ToCharArray().Where((c, i) => i % 2 != 0).Select(c => c - '0').ToList();
        ...
        """        
        002333133121414131402
        """.Split(Environment.NewLine);
        static string[] d9_data01 =
        """        
        12345
        """.Split(Environment.NewLine);
